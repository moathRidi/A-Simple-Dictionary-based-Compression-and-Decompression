###################################################################################################################################
############ Authers :Moath Ridi 1201507 , Abd Khuffash 1200970
...
############ A Simple Dictionary-based Compression and Decompression Tool
...
#  _____        _           _____                                 _                                                               #
# |  __ \      | |         / ____|                               | |                                                              #
# | |  | | __ _| |_ __ _  | (___   ___  __ _ _ __ ___   ___ _ __ | |_                                                             #
# | |  | |/ _` | __/ _` |  \___ \ / _ \/ _` | '_ ` _ \ / _ \ '_ \| __|                                                            #
# | |__| | (_| | || (_| |  ____) |  __/ (_| | | | | | |  __/ | | | |_                                                             #
# |_____/ \__,_|\__\__,_| |_____/ \___|\__, |_| |_| |_|\___|_| |_|\__|                                                            #
#                                       __/ |                                                                                     #
#                                      |___/                                                                                      #
###################################################################################################################################
.data
...
#  _______        _      _____                                 _                                                                  #
# |__   __|      | |    / ____|                               | |                                                                 #
#    | | _____  _| |_  | (___   ___  __ _ _ __ ___   ___ _ __ | |_                                                                #
#    | |/ _ \ \/ / __|  \___ \ / _ \/ _` | '_ ` _ \ / _ \ '_ \| __|                                                               #
#    | |  __/>  <| |_   ____) |  __/ (_| | | | | | |  __/ | | | |_                                                                #
#    |_|\___/_/\_\\__| |_____/ \___|\__, |_| |_| |_|\___|_| |_|\__|                                                               #
#                                    __/ |                                                                                        #
#                                   |___/                                                                                         #
###################################################################################################################################
...
# MAIN LABEL: Yes: There is a Dictionary exists already, asks user to enter the path and do the proper set of instructions        #
...
# MAIN LABEL :No : No Dictionary , New *Empty* dictionary will be created and has the name of Dictionary.txt                      #
...
# Options Entered :compress/compression/c                                                                                         #
...
# Options Entered : decompress/decompression/d                                                                                    #
...
# Maib Label: Exit:Printing Ratio output.                                                                                         #
...
# Used Functions: Compare Char,compare,equal,notequal,cstart: is used to compare Character to check if the user enter Compress/Decompress/c/d 
#                                                           and so on..

# errormsg: prints "invalid option" on Screan

#quitmsg: Prints "Quiting" on screan

#decompressionmsg: Prints "Performing decompressiong.." on Screan

#cut_onR: Cutting  the String on '\r' 
...
errormsg:
    	...
    	j cORd  #finally, jump to the exit label
